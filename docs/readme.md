...
Alternatively, you can use `For(Val`. `Val` is the number of times to execute the loop. 0=65536  
...
Programs must be prefixed with `"E"`, protected programs `"F"` and
appvars `"U"`.
